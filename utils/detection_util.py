...
def get_and_print_results( in_score, out_score):
    ...
    # output_file="/media/chaod/finetune-models/Coop-me/cocoop_imagenet1k_epoch100.txt"
    # with open(output_file, 'a') as f:
    #     f.write(f"auroc: {aurocs}\n")
    #     f.write(f"auprs: {auprs}\n")
    #     f.write(f"fprs: {fprs}\n")

def get_and_print_results2( in_score, out_score):
    '''
    1) evaluate detection performance for a given OOD test set (loader)
    2) print results (FPR95, AUROC, AUPR)
    '''
...
def get_and_print_results3( in_score, out_score):
    '''
    1) evaluate detection performance for a given OOD test set (loader)
    2) print results (FPR95, AUROC, AUPR)
    '''
    ...
    output_file="/media/chaod/finetune-models/Coop-me/coop_stl10.txt"
    with open(output_file, 'a') as f:
        f.write(f"auroc: {aurocs}\n")
        f.write(f"auprs: {auprs}\n")
        f.write(f"fprs: {fprs}\n")
